...
import com.secretingradient.ingradientlauncher.SnapGridLayout
...
abstract class BasePagerStage(context: Context) : BaseStage(context) {
    ...
    abstract class StageAdapter(val context: Context) : RecyclerView.Adapter<BoundViewHolder>() {
        val pages = mutableListOf<SnapGridLayout>()
        ...
        abstract fun createPage(context: Context, page: Int): SnapGridLayout
    }
}
